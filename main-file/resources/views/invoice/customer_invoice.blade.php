  ...
  <div class="row justify-content-between align-items-center mb-3">
      <div class="col-md-12 d-flex align-items-center justify-content-between justify-content-md-end">
          ...
          @if($invoice->status!=0 && $invoice->getDue() > 0
            && (!empty($company_payment_setting) && ($company_payment_setting['_transfer_enabled'] == 'on'
                                  ...
                                  <ul class="nav nav-pills  mb-3" role="tablist">
                                      ...
                                      @endif
                                          ...
                                          @if(isset($company_payment_setting['is_sspay_enabled']) && $company_payment_setting['is_sspay_enabled'] == 'on')
                                              <li class="nav-item mb-2">
                                                  <a class="btn btn-outline-primary btn-sm ml-1" data-bs-toggle="tab" href="#sspay-payment" role="tab" aria-controls="iyzipay" aria-selected="false">{{ __('SSPay') }}</a>
                                              </li>
                                          @endif
                                  </ul>
                              @endif
