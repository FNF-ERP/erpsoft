...
{{--                <option class="" @if($lang == $language) selected @endif value="{{ route('register',$language) }}">{{ucfirst($language)}}</option>--}}
{{--            @endforeach--}}
{{--        </select>--}}
{{--    </li>--}}

    <li class="nav-item">
        <select class="btn btn-primary my-1 language_option_bg " onchange="this.options[this.selectedIndex].value && (window.location = this.options[this.selectedIndex].value);" id="language">
            @foreach(Utility::languages() as $code =>  $language)
                <option class="" @if($lang == $code) selected @endif value="{{ route('register',$code) }}">{{ucfirst($language)}}</option>
            @endforeach
        </select>
    </li>
