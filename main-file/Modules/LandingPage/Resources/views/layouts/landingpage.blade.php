                    ...
                    <div class="col-xxl-3 col-lg-4 col-md-6">
                        <div
                            ...
                            <div class="card-body">
                                ...
                                <span class="mb-4 f-w-600 p-price">{{ env('CURRENCY_SYMBOL').$value->price }}<small
                                ...
                                <ul class="list-unstyled my-3">
                                    ...
                                    <li>
                                        <div class="form-check text-start">
                                            <input class="form-check-input input-primary" type="checkbox" id="customCheckc1"
                                                {{ $value->max_customers != 0 ? 'checked' : "" }}>
                                            <label class="form-check-label" for="customCheckc1">{{ $value->max_customers }}
                                                {{__('Customer')}}</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                            <input class="form-check-input input-primary" type="checkbox" id="customCheckc1"
                                                {{ $value->max_venders != 0 ? 'checked' : "" }}>
                                            <label class="form-check-label" for="customCheckc1">{{ $value->max_venders }}
                                                {{__('Vendors')}}</label>
                                        </div>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        <div class="form-check text-start">
                                            <input class="form-check-input input-primary" type="checkbox" id="customCheckc1"
                                                {{ $value->crm != 0 ? 'checked' : "" }}>
                                            <label class="form-check-label"
                                                for="customCheckc1">{{ $value->crm ==1 ? 'Enable' : 'Disable' }} {{__('CRM')}}</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                            <input class="form-check-input input-primary" type="checkbox" id="customCheckc1"
                                                {{ $value->hrm != 0 ? 'checked' : "" }}>
                                            <label class="form-check-label"
                                                for="customCheckc1">{{ $value->hrm ==1 ? 'Enable' : 'Disable' }} {{__('HRM')}}</label>
                                        </div>
                                    </li>
                                    <li>
                                        <div class="form-check text-start">
                                            <input class="form-check-input input-primary" type="checkbox" id="customCheckc1"
                                                {{ $value->project != 0 ? 'checked' : "" }}>
                                            <label class="form-check-label"
                                    ...
                                    <li>
                                        <div class="form-check text-start">
                                            <input class="form-check-input input-primary" type="checkbox" id="customCheckc1"
                                                {{ $value->pos != 0 ? 'checked' : "" }}>
                                            <label class="form-check-label"
                                                for="customCheckc1">{{ $value->pos ==1 ? 'Enable' : 'Disable' }} {{__('POS')}}</label>
                                        </div>
                                    </li>
                                ...
                                <div class="d-grid">
                                    <a href="{{ route('register') }}" class="btn btn-primary rounded-pill">{{__('Start with Starter')}} <i data-feather="log-in" class="ms-2"></i> </a>
                                </div>
                            </div>
                        </div>
                    </div>
